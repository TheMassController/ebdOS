...
CFLAGS = -mcpu=cortex-m4 -mfloat-abi=softfp -ffunction-sections -fdata-sections -std=c99 -Wall -pedantic -MMD -MP -mthumb $(INC) -DPART_LM4F120H5QR -DTARGET_IS_BLIZZARD_RA1
