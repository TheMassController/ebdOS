...
N *
N */
N#include "inc/lm4f120h5qr.h"
L 1 "C:/StellarisWare/inc/lm4f120h5qr.h" 1
N//*****************************************************************************
N//
N// lm4f120h5qr.h - LM4F120H5QR Register Definitions
N//
...
N// 
N// This is part of revision 9453 of the Stellaris Firmware Development Package.
N//
N//*****************************************************************************
N
N#ifndef __LM4F120H5QR_H__
N#define __LM4F120H5QR_H__
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTA_SI_R         (*((volatile unsigned long *)0x40004538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTB_SI_R         (*((volatile unsigned long *)0x40005538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTC_SI_R         (*((volatile unsigned long *)0x40006538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTD_SI_R         (*((volatile unsigned long *)0x40007538))
N
N//*****************************************************************************
N//
...
N#define UART0_LCTL_R            (*((volatile unsigned long *)0x4000C090))
N#define UART0_LSS_R             (*((volatile unsigned long *)0x4000C094))
N#define UART0_LTIM_R            (*((volatile unsigned long *)0x4000C098))
...
N#define UART1_LCTL_R            (*((volatile unsigned long *)0x4000D090))
N#define UART1_LSS_R             (*((volatile unsigned long *)0x4000D094))
N#define UART1_LTIM_R            (*((volatile unsigned long *)0x4000D098))
...
N#define UART2_LCTL_R            (*((volatile unsigned long *)0x4000E090))
N#define UART2_LSS_R             (*((volatile unsigned long *)0x4000E094))
N#define UART2_LTIM_R            (*((volatile unsigned long *)0x4000E098))
...
N#define UART3_LCTL_R            (*((volatile unsigned long *)0x4000F090))
N#define UART3_LSS_R             (*((volatile unsigned long *)0x4000F094))
N#define UART3_LTIM_R            (*((volatile unsigned long *)0x4000F098))
...
N#define UART4_LCTL_R            (*((volatile unsigned long *)0x40010090))
N#define UART4_LSS_R             (*((volatile unsigned long *)0x40010094))
N#define UART4_LTIM_R            (*((volatile unsigned long *)0x40010098))
...
N#define UART5_LCTL_R            (*((volatile unsigned long *)0x40011090))
N#define UART5_LSS_R             (*((volatile unsigned long *)0x40011094))
N#define UART5_LTIM_R            (*((volatile unsigned long *)0x40011098))
...
N#define UART6_LCTL_R            (*((volatile unsigned long *)0x40012090))
N#define UART6_LSS_R             (*((volatile unsigned long *)0x40012094))
N#define UART6_LTIM_R            (*((volatile unsigned long *)0x40012098))
...
N#define UART7_LCTL_R            (*((volatile unsigned long *)0x40013090))
N#define UART7_LSS_R             (*((volatile unsigned long *)0x40013094))
N#define UART7_LTIM_R            (*((volatile unsigned long *)0x40013098))
...
N//*****************************************************************************
N//
N// I2C registers (I2C0 MASTER)
N//
N//*****************************************************************************
N#define I2C0_MASTER_MSA_R       (*((volatile unsigned long *)0x40020000))
N#define I2C0_MASTER_MCS_R       (*((volatile unsigned long *)0x40020004))
N#define I2C0_MASTER_MDR_R       (*((volatile unsigned long *)0x40020008))
N#define I2C0_MASTER_MTPR_R      (*((volatile unsigned long *)0x4002000C))
N#define I2C0_MASTER_MIMR_R      (*((volatile unsigned long *)0x40020010))
N#define I2C0_MASTER_MRIS_R      (*((volatile unsigned long *)0x40020014))
N#define I2C0_MASTER_MMIS_R      (*((volatile unsigned long *)0x40020018))
N#define I2C0_MASTER_MICR_R      (*((volatile unsigned long *)0x4002001C))
N#define I2C0_MASTER_MCR_R       (*((volatile unsigned long *)0x40020020))
N#define I2C0_MASTER_MCLKOCNT_R  (*((volatile unsigned long *)0x40020024))
N#define I2C0_MASTER_MBMON_R     (*((volatile unsigned long *)0x4002002C))
N
N//*****************************************************************************
N//
N// I2C registers (I2C0 SLAVE)
N//
N//*****************************************************************************
N#define I2C0_SLAVE_SOAR_R       (*((volatile unsigned long *)0x40020800))
N#define I2C0_SLAVE_SCSR_R       (*((volatile unsigned long *)0x40020804))
N#define I2C0_SLAVE_SDR_R        (*((volatile unsigned long *)0x40020808))
N#define I2C0_SLAVE_SIMR_R       (*((volatile unsigned long *)0x4002080C))
N#define I2C0_SLAVE_SRIS_R       (*((volatile unsigned long *)0x40020810))
N#define I2C0_SLAVE_SMIS_R       (*((volatile unsigned long *)0x40020814))
N#define I2C0_SLAVE_SICR_R       (*((volatile unsigned long *)0x40020818))
N#define I2C0_SLAVE_SOAR2_R      (*((volatile unsigned long *)0x4002081C))
N#define I2C0_SLAVE_SACKCTL_R    (*((volatile unsigned long *)0x40020820))
N
N//*****************************************************************************
N//
N// I2C registers (I2C1 MASTER)
N//
N//*****************************************************************************
N#define I2C1_MASTER_MSA_R       (*((volatile unsigned long *)0x40021000))
N#define I2C1_MASTER_MCS_R       (*((volatile unsigned long *)0x40021004))
N#define I2C1_MASTER_MDR_R       (*((volatile unsigned long *)0x40021008))
N#define I2C1_MASTER_MTPR_R      (*((volatile unsigned long *)0x4002100C))
N#define I2C1_MASTER_MIMR_R      (*((volatile unsigned long *)0x40021010))
N#define I2C1_MASTER_MRIS_R      (*((volatile unsigned long *)0x40021014))
N#define I2C1_MASTER_MMIS_R      (*((volatile unsigned long *)0x40021018))
N#define I2C1_MASTER_MICR_R      (*((volatile unsigned long *)0x4002101C))
N#define I2C1_MASTER_MCR_R       (*((volatile unsigned long *)0x40021020))
N#define I2C1_MASTER_MCLKOCNT_R  (*((volatile unsigned long *)0x40021024))
N#define I2C1_MASTER_MBMON_R     (*((volatile unsigned long *)0x4002102C))
N
N//*****************************************************************************
N//
N// I2C registers (I2C1 SLAVE)
N//
N//*****************************************************************************
N#define I2C1_SLAVE_SOAR_R       (*((volatile unsigned long *)0x40021800))
N#define I2C1_SLAVE_SCSR_R       (*((volatile unsigned long *)0x40021804))
N#define I2C1_SLAVE_SDR_R        (*((volatile unsigned long *)0x40021808))
N#define I2C1_SLAVE_SIMR_R       (*((volatile unsigned long *)0x4002180C))
N#define I2C1_SLAVE_SRIS_R       (*((volatile unsigned long *)0x40021810))
N#define I2C1_SLAVE_SMIS_R       (*((volatile unsigned long *)0x40021814))
N#define I2C1_SLAVE_SICR_R       (*((volatile unsigned long *)0x40021818))
N#define I2C1_SLAVE_SOAR2_R      (*((volatile unsigned long *)0x4002181C))
N#define I2C1_SLAVE_SACKCTL_R    (*((volatile unsigned long *)0x40021820))
N
N//*****************************************************************************
N//
N// I2C registers (I2C2 MASTER)
N//
N//*****************************************************************************
N#define I2C2_MASTER_MSA_R       (*((volatile unsigned long *)0x40022000))
N#define I2C2_MASTER_MCS_R       (*((volatile unsigned long *)0x40022004))
N#define I2C2_MASTER_MDR_R       (*((volatile unsigned long *)0x40022008))
N#define I2C2_MASTER_MTPR_R      (*((volatile unsigned long *)0x4002200C))
N#define I2C2_MASTER_MIMR_R      (*((volatile unsigned long *)0x40022010))
N#define I2C2_MASTER_MRIS_R      (*((volatile unsigned long *)0x40022014))
N#define I2C2_MASTER_MMIS_R      (*((volatile unsigned long *)0x40022018))
N#define I2C2_MASTER_MICR_R      (*((volatile unsigned long *)0x4002201C))
N#define I2C2_MASTER_MCR_R       (*((volatile unsigned long *)0x40022020))
N#define I2C2_MASTER_MCLKOCNT_R  (*((volatile unsigned long *)0x40022024))
N#define I2C2_MASTER_MBMON_R     (*((volatile unsigned long *)0x4002202C))
N
N//*****************************************************************************
N//
N// I2C registers (I2C2 SLAVE)
N//
N//*****************************************************************************
N#define I2C2_SLAVE_SOAR_R       (*((volatile unsigned long *)0x40022800))
N#define I2C2_SLAVE_SCSR_R       (*((volatile unsigned long *)0x40022804))
N#define I2C2_SLAVE_SDR_R        (*((volatile unsigned long *)0x40022808))
N#define I2C2_SLAVE_SIMR_R       (*((volatile unsigned long *)0x4002280C))
N#define I2C2_SLAVE_SRIS_R       (*((volatile unsigned long *)0x40022810))
N#define I2C2_SLAVE_SMIS_R       (*((volatile unsigned long *)0x40022814))
N#define I2C2_SLAVE_SICR_R       (*((volatile unsigned long *)0x40022818))
N#define I2C2_SLAVE_SOAR2_R      (*((volatile unsigned long *)0x4002281C))
N#define I2C2_SLAVE_SACKCTL_R    (*((volatile unsigned long *)0x40022820))
N
N//*****************************************************************************
N//
N// I2C registers (I2C3 MASTER)
N//
N//*****************************************************************************
N#define I2C3_MASTER_MSA_R       (*((volatile unsigned long *)0x40023000))
N#define I2C3_MASTER_MCS_R       (*((volatile unsigned long *)0x40023004))
N#define I2C3_MASTER_MDR_R       (*((volatile unsigned long *)0x40023008))
N#define I2C3_MASTER_MTPR_R      (*((volatile unsigned long *)0x4002300C))
N#define I2C3_MASTER_MIMR_R      (*((volatile unsigned long *)0x40023010))
N#define I2C3_MASTER_MRIS_R      (*((volatile unsigned long *)0x40023014))
N#define I2C3_MASTER_MMIS_R      (*((volatile unsigned long *)0x40023018))
N#define I2C3_MASTER_MICR_R      (*((volatile unsigned long *)0x4002301C))
N#define I2C3_MASTER_MCR_R       (*((volatile unsigned long *)0x40023020))
N#define I2C3_MASTER_MCLKOCNT_R  (*((volatile unsigned long *)0x40023024))
N#define I2C3_MASTER_MBMON_R     (*((volatile unsigned long *)0x4002302C))
N
N//*****************************************************************************
N//
N// I2C registers (I2C3 SLAVE)
N//
N//*****************************************************************************
N#define I2C3_SLAVE_SOAR_R       (*((volatile unsigned long *)0x40023800))
N#define I2C3_SLAVE_SCSR_R       (*((volatile unsigned long *)0x40023804))
N#define I2C3_SLAVE_SDR_R        (*((volatile unsigned long *)0x40023808))
N#define I2C3_SLAVE_SIMR_R       (*((volatile unsigned long *)0x4002380C))
N#define I2C3_SLAVE_SRIS_R       (*((volatile unsigned long *)0x40023810))
N#define I2C3_SLAVE_SMIS_R       (*((volatile unsigned long *)0x40023814))
N#define I2C3_SLAVE_SICR_R       (*((volatile unsigned long *)0x40023818))
N#define I2C3_SLAVE_SOAR2_R      (*((volatile unsigned long *)0x4002381C))
N#define I2C3_SLAVE_SACKCTL_R    (*((volatile unsigned long *)0x40023820))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTE_SI_R         (*((volatile unsigned long *)0x40024538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTF_SI_R         (*((volatile unsigned long *)0x40025538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTA_AHB_SI_R     (*((volatile unsigned long *)0x40058538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTB_AHB_SI_R     (*((volatile unsigned long *)0x40059538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTC_AHB_SI_R     (*((volatile unsigned long *)0x4005A538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTD_AHB_SI_R     (*((volatile unsigned long *)0x4005B538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTE_AHB_SI_R     (*((volatile unsigned long *)0x4005C538))
N
N//*****************************************************************************
N//
...
N#define GPIO_PORTF_AHB_SI_R     (*((volatile unsigned long *)0x4005D538))
N
N//*****************************************************************************
N//
...
N#define SYSCTL_PCWD_R           (*((volatile unsigned long *)0x400FE900))
N#define SYSCTL_PCTIMER_R        (*((volatile unsigned long *)0x400FE904))
N#define SYSCTL_PCGPIO_R         (*((volatile unsigned long *)0x400FE908))
N#define SYSCTL_PCDMA_R          (*((volatile unsigned long *)0x400FE90C))
N#define SYSCTL_PCHIB_R          (*((volatile unsigned long *)0x400FE914))
N#define SYSCTL_PCUART_R         (*((volatile unsigned long *)0x400FE918))
N#define SYSCTL_PCSSI_R          (*((volatile unsigned long *)0x400FE91C))
N#define SYSCTL_PCI2C_R          (*((volatile unsigned long *)0x400FE920))
N#define SYSCTL_PCUSB_R          (*((volatile unsigned long *)0x400FE928))
N#define SYSCTL_PCCAN_R          (*((volatile unsigned long *)0x400FE934))
N#define SYSCTL_PCADC_R          (*((volatile unsigned long *)0x400FE938))
N#define SYSCTL_PCACMP_R         (*((volatile unsigned long *)0x400FE93C))
N#define SYSCTL_PCEEPROM_R       (*((volatile unsigned long *)0x400FE958))
N#define SYSCTL_PCWTIMER_R       (*((volatile unsigned long *)0x400FE95C))
...
N//
N//*****************************************************************************
N#define NVIC_INT_TYPE_R         (*((volatile unsigned long *)0xE000E004))
...
N#define NVIC_ST_CAL_R           (*((volatile unsigned long *)0xE000E01C))
...
N#define GPIO_PCTL_PF0_TRD2      0x0000000E  // TRD2 on PF0
N
N//*****************************************************************************
N//
...
N#define I2C_MTPR_TPR_M          0x0000007F  // SCL Clock Period
...
N#define ADC_SSPRI_SS3_1ST       0x00000000  // First priority
N#define ADC_SSPRI_SS3_2ND       0x00001000  // Second priority
N#define ADC_SSPRI_SS3_3RD       0x00002000  // Third priority
N#define ADC_SSPRI_SS3_4TH       0x00003000  // Fourth priority
N#define ADC_SSPRI_SS2_M         0x00000300  // SS2 Priority
N#define ADC_SSPRI_SS2_1ST       0x00000000  // First priority
N#define ADC_SSPRI_SS2_2ND       0x00000100  // Second priority
N#define ADC_SSPRI_SS2_3RD       0x00000200  // Third priority
N#define ADC_SSPRI_SS2_4TH       0x00000300  // Fourth priority
N#define ADC_SSPRI_SS1_M         0x00000030  // SS1 Priority
N#define ADC_SSPRI_SS1_1ST       0x00000000  // First priority
N#define ADC_SSPRI_SS1_2ND       0x00000010  // Second priority
N#define ADC_SSPRI_SS1_3RD       0x00000020  // Third priority
N#define ADC_SSPRI_SS1_4TH       0x00000030  // Fourth priority
N#define ADC_SSPRI_SS0_M         0x00000003  // SS0 Priority
N#define ADC_SSPRI_SS0_1ST       0x00000000  // First priority
N#define ADC_SSPRI_SS0_2ND       0x00000001  // Second priority
N#define ADC_SSPRI_SS0_3RD       0x00000002  // Third priority
N#define ADC_SSPRI_SS0_4TH       0x00000003  // Fourth priority
N
N//*****************************************************************************
N//
...
N#define HIB_CTL_LOWBATEN        0x00000020  // Low Battery Monitoring Enable
...
N//*****************************************************************************
N//
N// The following are defines for the bit fields in the NVIC_INT_TYPE register.
N//
N//*****************************************************************************
N#define NVIC_INT_TYPE_LINES_M   0x0000001F  // Number of interrupt lines (x32)
N#define NVIC_INT_TYPE_LINES_S   0
N
N//*****************************************************************************
N//
...
N//*****************************************************************************
N//
N// The following are defines for the bit fields in the NVIC_ST_CAL register.
N//
N//*****************************************************************************
N#define NVIC_ST_CAL_NOREF       0x80000000  // No reference clock
N#define NVIC_ST_CAL_SKEW        0x40000000  // Clock skew
N#define NVIC_ST_CAL_ONEMS_M     0x00FFFFFF  // 1ms reference value
N#define NVIC_ST_CAL_ONEMS_S     0
N
N//*****************************************************************************
N//
...
N#define NVIC_EN0_INT0           0x00000001  // Interrupt 0 enable
N#define NVIC_EN0_INT1           0x00000002  // Interrupt 1 enable
N#define NVIC_EN0_INT2           0x00000004  // Interrupt 2 enable
N#define NVIC_EN0_INT3           0x00000008  // Interrupt 3 enable
N#define NVIC_EN0_INT4           0x00000010  // Interrupt 4 enable
N#define NVIC_EN0_INT5           0x00000020  // Interrupt 5 enable
N#define NVIC_EN0_INT6           0x00000040  // Interrupt 6 enable
N#define NVIC_EN0_INT7           0x00000080  // Interrupt 7 enable
N#define NVIC_EN0_INT8           0x00000100  // Interrupt 8 enable
N#define NVIC_EN0_INT9           0x00000200  // Interrupt 9 enable
N#define NVIC_EN0_INT10          0x00000400  // Interrupt 10 enable
N#define NVIC_EN0_INT11          0x00000800  // Interrupt 11 enable
N#define NVIC_EN0_INT12          0x00001000  // Interrupt 12 enable
N#define NVIC_EN0_INT13          0x00002000  // Interrupt 13 enable
N#define NVIC_EN0_INT14          0x00004000  // Interrupt 14 enable
N#define NVIC_EN0_INT15          0x00008000  // Interrupt 15 enable
N#define NVIC_EN0_INT16          0x00010000  // Interrupt 16 enable
N#define NVIC_EN0_INT17          0x00020000  // Interrupt 17 enable
N#define NVIC_EN0_INT18          0x00040000  // Interrupt 18 enable
N#define NVIC_EN0_INT19          0x00080000  // Interrupt 19 enable
N#define NVIC_EN0_INT20          0x00100000  // Interrupt 20 enable
N#define NVIC_EN0_INT21          0x00200000  // Interrupt 21 enable
N#define NVIC_EN0_INT22          0x00400000  // Interrupt 22 enable
N#define NVIC_EN0_INT23          0x00800000  // Interrupt 23 enable
N#define NVIC_EN0_INT24          0x01000000  // Interrupt 24 enable
N#define NVIC_EN0_INT25          0x02000000  // Interrupt 25 enable
N#define NVIC_EN0_INT26          0x04000000  // Interrupt 26 enable
N#define NVIC_EN0_INT27          0x08000000  // Interrupt 27 enable
N#define NVIC_EN0_INT28          0x10000000  // Interrupt 28 enable
N#define NVIC_EN0_INT29          0x20000000  // Interrupt 29 enable
N#define NVIC_EN0_INT30          0x40000000  // Interrupt 30 enable
N#define NVIC_EN0_INT31          0x80000000  // Interrupt 31 enable
N
N//*****************************************************************************
N//
...
N#define NVIC_DIS0_INT0          0x00000001  // Interrupt 0 disable
N#define NVIC_DIS0_INT1          0x00000002  // Interrupt 1 disable
N#define NVIC_DIS0_INT2          0x00000004  // Interrupt 2 disable
N#define NVIC_DIS0_INT3          0x00000008  // Interrupt 3 disable
N#define NVIC_DIS0_INT4          0x00000010  // Interrupt 4 disable
N#define NVIC_DIS0_INT5          0x00000020  // Interrupt 5 disable
N#define NVIC_DIS0_INT6          0x00000040  // Interrupt 6 disable
N#define NVIC_DIS0_INT7          0x00000080  // Interrupt 7 disable
N#define NVIC_DIS0_INT8          0x00000100  // Interrupt 8 disable
N#define NVIC_DIS0_INT9          0x00000200  // Interrupt 9 disable
N#define NVIC_DIS0_INT10         0x00000400  // Interrupt 10 disable
N#define NVIC_DIS0_INT11         0x00000800  // Interrupt 11 disable
N#define NVIC_DIS0_INT12         0x00001000  // Interrupt 12 disable
N#define NVIC_DIS0_INT13         0x00002000  // Interrupt 13 disable
N#define NVIC_DIS0_INT14         0x00004000  // Interrupt 14 disable
N#define NVIC_DIS0_INT15         0x00008000  // Interrupt 15 disable
N#define NVIC_DIS0_INT16         0x00010000  // Interrupt 16 disable
N#define NVIC_DIS0_INT17         0x00020000  // Interrupt 17 disable
N#define NVIC_DIS0_INT18         0x00040000  // Interrupt 18 disable
N#define NVIC_DIS0_INT19         0x00080000  // Interrupt 19 disable
N#define NVIC_DIS0_INT20         0x00100000  // Interrupt 20 disable
N#define NVIC_DIS0_INT21         0x00200000  // Interrupt 21 disable
N#define NVIC_DIS0_INT22         0x00400000  // Interrupt 22 disable
N#define NVIC_DIS0_INT23         0x00800000  // Interrupt 23 disable
N#define NVIC_DIS0_INT24         0x01000000  // Interrupt 24 disable
N#define NVIC_DIS0_INT25         0x02000000  // Interrupt 25 disable
N#define NVIC_DIS0_INT26         0x04000000  // Interrupt 26 disable
N#define NVIC_DIS0_INT27         0x08000000  // Interrupt 27 disable
N#define NVIC_DIS0_INT28         0x10000000  // Interrupt 28 disable
N#define NVIC_DIS0_INT29         0x20000000  // Interrupt 29 disable
N#define NVIC_DIS0_INT30         0x40000000  // Interrupt 30 disable
N#define NVIC_DIS0_INT31         0x80000000  // Interrupt 31 disable
N
N//*****************************************************************************
N//
...
N#define NVIC_PEND0_INT0         0x00000001  // Interrupt 0 pend
N#define NVIC_PEND0_INT1         0x00000002  // Interrupt 1 pend
N#define NVIC_PEND0_INT2         0x00000004  // Interrupt 2 pend
N#define NVIC_PEND0_INT3         0x00000008  // Interrupt 3 pend
N#define NVIC_PEND0_INT4         0x00000010  // Interrupt 4 pend
N#define NVIC_PEND0_INT5         0x00000020  // Interrupt 5 pend
N#define NVIC_PEND0_INT6         0x00000040  // Interrupt 6 pend
N#define NVIC_PEND0_INT7         0x00000080  // Interrupt 7 pend
N#define NVIC_PEND0_INT8         0x00000100  // Interrupt 8 pend
N#define NVIC_PEND0_INT9         0x00000200  // Interrupt 9 pend
N#define NVIC_PEND0_INT10        0x00000400  // Interrupt 10 pend
N#define NVIC_PEND0_INT11        0x00000800  // Interrupt 11 pend
N#define NVIC_PEND0_INT12        0x00001000  // Interrupt 12 pend
N#define NVIC_PEND0_INT13        0x00002000  // Interrupt 13 pend
N#define NVIC_PEND0_INT14        0x00004000  // Interrupt 14 pend
N#define NVIC_PEND0_INT15        0x00008000  // Interrupt 15 pend
N#define NVIC_PEND0_INT16        0x00010000  // Interrupt 16 pend
N#define NVIC_PEND0_INT17        0x00020000  // Interrupt 17 pend
N#define NVIC_PEND0_INT18        0x00040000  // Interrupt 18 pend
N#define NVIC_PEND0_INT19        0x00080000  // Interrupt 19 pend
N#define NVIC_PEND0_INT20        0x00100000  // Interrupt 20 pend
N#define NVIC_PEND0_INT21        0x00200000  // Interrupt 21 pend
N#define NVIC_PEND0_INT22        0x00400000  // Interrupt 22 pend
N#define NVIC_PEND0_INT23        0x00800000  // Interrupt 23 pend
N#define NVIC_PEND0_INT24        0x01000000  // Interrupt 24 pend
N#define NVIC_PEND0_INT25        0x02000000  // Interrupt 25 pend
N#define NVIC_PEND0_INT26        0x04000000  // Interrupt 26 pend
N#define NVIC_PEND0_INT27        0x08000000  // Interrupt 27 pend
N#define NVIC_PEND0_INT28        0x10000000  // Interrupt 28 pend
N#define NVIC_PEND0_INT29        0x20000000  // Interrupt 29 pend
N#define NVIC_PEND0_INT30        0x40000000  // Interrupt 30 pend
N#define NVIC_PEND0_INT31        0x80000000  // Interrupt 31 pend
N
N//*****************************************************************************
N//
...
N#define NVIC_UNPEND0_INT0       0x00000001  // Interrupt 0 unpend
N#define NVIC_UNPEND0_INT1       0x00000002  // Interrupt 1 unpend
N#define NVIC_UNPEND0_INT2       0x00000004  // Interrupt 2 unpend
N#define NVIC_UNPEND0_INT3       0x00000008  // Interrupt 3 unpend
N#define NVIC_UNPEND0_INT4       0x00000010  // Interrupt 4 unpend
N#define NVIC_UNPEND0_INT5       0x00000020  // Interrupt 5 unpend
N#define NVIC_UNPEND0_INT6       0x00000040  // Interrupt 6 unpend
N#define NVIC_UNPEND0_INT7       0x00000080  // Interrupt 7 unpend
N#define NVIC_UNPEND0_INT8       0x00000100  // Interrupt 8 unpend
N#define NVIC_UNPEND0_INT9       0x00000200  // Interrupt 9 unpend
N#define NVIC_UNPEND0_INT10      0x00000400  // Interrupt 10 unpend
N#define NVIC_UNPEND0_INT11      0x00000800  // Interrupt 11 unpend
N#define NVIC_UNPEND0_INT12      0x00001000  // Interrupt 12 unpend
N#define NVIC_UNPEND0_INT13      0x00002000  // Interrupt 13 unpend
N#define NVIC_UNPEND0_INT14      0x00004000  // Interrupt 14 unpend
N#define NVIC_UNPEND0_INT15      0x00008000  // Interrupt 15 unpend
N#define NVIC_UNPEND0_INT16      0x00010000  // Interrupt 16 unpend
N#define NVIC_UNPEND0_INT17      0x00020000  // Interrupt 17 unpend
N#define NVIC_UNPEND0_INT18      0x00040000  // Interrupt 18 unpend
N#define NVIC_UNPEND0_INT19      0x00080000  // Interrupt 19 unpend
N#define NVIC_UNPEND0_INT20      0x00100000  // Interrupt 20 unpend
N#define NVIC_UNPEND0_INT21      0x00200000  // Interrupt 21 unpend
N#define NVIC_UNPEND0_INT22      0x00400000  // Interrupt 22 unpend
N#define NVIC_UNPEND0_INT23      0x00800000  // Interrupt 23 unpend
N#define NVIC_UNPEND0_INT24      0x01000000  // Interrupt 24 unpend
N#define NVIC_UNPEND0_INT25      0x02000000  // Interrupt 25 unpend
N#define NVIC_UNPEND0_INT26      0x04000000  // Interrupt 26 unpend
N#define NVIC_UNPEND0_INT27      0x08000000  // Interrupt 27 unpend
N#define NVIC_UNPEND0_INT28      0x10000000  // Interrupt 28 unpend
N#define NVIC_UNPEND0_INT29      0x20000000  // Interrupt 29 unpend
N#define NVIC_UNPEND0_INT30      0x40000000  // Interrupt 30 unpend
N#define NVIC_UNPEND0_INT31      0x80000000  // Interrupt 31 unpend
N
N//*****************************************************************************
N//
...
N#define NVIC_UNPEND1_INT32      0x00000001  // Interrupt 32 unpend
N#define NVIC_UNPEND1_INT33      0x00000002  // Interrupt 33 unpend
N#define NVIC_UNPEND1_INT34      0x00000004  // Interrupt 34 unpend
N#define NVIC_UNPEND1_INT35      0x00000008  // Interrupt 35 unpend
N#define NVIC_UNPEND1_INT36      0x00000010  // Interrupt 36 unpend
N#define NVIC_UNPEND1_INT37      0x00000020  // Interrupt 37 unpend
N#define NVIC_UNPEND1_INT38      0x00000040  // Interrupt 38 unpend
N#define NVIC_UNPEND1_INT39      0x00000080  // Interrupt 39 unpend
N#define NVIC_UNPEND1_INT40      0x00000100  // Interrupt 40 unpend
N#define NVIC_UNPEND1_INT41      0x00000200  // Interrupt 41 unpend
N#define NVIC_UNPEND1_INT42      0x00000400  // Interrupt 42 unpend
N#define NVIC_UNPEND1_INT43      0x00000800  // Interrupt 43 unpend
N#define NVIC_UNPEND1_INT44      0x00001000  // Interrupt 44 unpend
N#define NVIC_UNPEND1_INT45      0x00002000  // Interrupt 45 unpend
N#define NVIC_UNPEND1_INT46      0x00004000  // Interrupt 46 unpend
N#define NVIC_UNPEND1_INT47      0x00008000  // Interrupt 47 unpend
N#define NVIC_UNPEND1_INT48      0x00010000  // Interrupt 48 unpend
N#define NVIC_UNPEND1_INT49      0x00020000  // Interrupt 49 unpend
N#define NVIC_UNPEND1_INT50      0x00040000  // Interrupt 50 unpend
N#define NVIC_UNPEND1_INT51      0x00080000  // Interrupt 51 unpend
N#define NVIC_UNPEND1_INT52      0x00100000  // Interrupt 52 unpend
N#define NVIC_UNPEND1_INT53      0x00200000  // Interrupt 53 unpend
N#define NVIC_UNPEND1_INT54      0x00400000  // Interrupt 54 unpend
N#define NVIC_UNPEND1_INT55      0x00800000  // Interrupt 55 unpend
N
N//*****************************************************************************
N//
...
N#define NVIC_ACTIVE0_INT0       0x00000001  // Interrupt 0 active
N#define NVIC_ACTIVE0_INT1       0x00000002  // Interrupt 1 active
N#define NVIC_ACTIVE0_INT2       0x00000004  // Interrupt 2 active
N#define NVIC_ACTIVE0_INT3       0x00000008  // Interrupt 3 active
N#define NVIC_ACTIVE0_INT4       0x00000010  // Interrupt 4 active
N#define NVIC_ACTIVE0_INT5       0x00000020  // Interrupt 5 active
N#define NVIC_ACTIVE0_INT6       0x00000040  // Interrupt 6 active
N#define NVIC_ACTIVE0_INT7       0x00000080  // Interrupt 7 active
N#define NVIC_ACTIVE0_INT8       0x00000100  // Interrupt 8 active
N#define NVIC_ACTIVE0_INT9       0x00000200  // Interrupt 9 active
N#define NVIC_ACTIVE0_INT10      0x00000400  // Interrupt 10 active
N#define NVIC_ACTIVE0_INT11      0x00000800  // Interrupt 11 active
N#define NVIC_ACTIVE0_INT12      0x00001000  // Interrupt 12 active
N#define NVIC_ACTIVE0_INT13      0x00002000  // Interrupt 13 active
N#define NVIC_ACTIVE0_INT14      0x00004000  // Interrupt 14 active
N#define NVIC_ACTIVE0_INT15      0x00008000  // Interrupt 15 active
N#define NVIC_ACTIVE0_INT16      0x00010000  // Interrupt 16 active
N#define NVIC_ACTIVE0_INT17      0x00020000  // Interrupt 17 active
N#define NVIC_ACTIVE0_INT18      0x00040000  // Interrupt 18 active
N#define NVIC_ACTIVE0_INT19      0x00080000  // Interrupt 19 active
N#define NVIC_ACTIVE0_INT20      0x00100000  // Interrupt 20 active
N#define NVIC_ACTIVE0_INT21      0x00200000  // Interrupt 21 active
N#define NVIC_ACTIVE0_INT22      0x00400000  // Interrupt 22 active
N#define NVIC_ACTIVE0_INT23      0x00800000  // Interrupt 23 active
N#define NVIC_ACTIVE0_INT24      0x01000000  // Interrupt 24 active
N#define NVIC_ACTIVE0_INT25      0x02000000  // Interrupt 25 active
N#define NVIC_ACTIVE0_INT26      0x04000000  // Interrupt 26 active
N#define NVIC_ACTIVE0_INT27      0x08000000  // Interrupt 27 active
N#define NVIC_ACTIVE0_INT28      0x10000000  // Interrupt 28 active
N#define NVIC_ACTIVE0_INT29      0x20000000  // Interrupt 29 active
N#define NVIC_ACTIVE0_INT30      0x40000000  // Interrupt 30 active
N#define NVIC_ACTIVE0_INT31      0x80000000  // Interrupt 31 active
N
N//*****************************************************************************
N//
...
N//*****************************************************************************
N//
N// Deprecated defines for the EEPROM register offsets.
N//
N//*****************************************************************************
N#define EEPROM_EEPROMPP_R       (*((volatile unsigned long *)0x400AFFC0))
N
N//*****************************************************************************
N//
N// Deprecated defines for the bit fields in the EEPROM_EEPROMPP register.
N//
N//*****************************************************************************
N#define EEPROM_EEPROMPP_SIZE_M  0x0000001F  // EEPROM Size
N#define EEPROM_EEPROMPP_SIZE_S  0
N
N#endif
N
N#endif // __LM4F120H5QR_H__
L 9 "../src/schedule.c" 2
...
N
N#endif /* SCHEDULE_H_ */
L 10 "../src/schedule.c" 2
N#include "task.h"
N
N#define MAIN_RETURN 	0xFFFFFFF9 //Tells the handler to return using the MSP
N#define THREAD_RETURN 	0xFFFFFFFD //Tells the handler to return using the PSP
N
Nextern task taskList[16];
N
N//Kies de volgende taak
Ntask * currentTask;
Ntask * taskToExecute;
N
N/*
N * This variable is used to make sure we can safely use R0
N * with the assembly routines and not overwrite any other context
N*/
Nint iTempRegister=0;
N
N/*
N * The Systick ISR does the following:
N * push cpu context to Task stack
N *
N * select the next task
N *
N * call the pendsv isr to switch
N * OR
N * pop back the context
N * */
Nvoid SystickISR(void)
N{
N	//Push cpu context to PSP
N	pushRegistersToCurrentPSP(iTempRegister);
N
N	//Save the new stack pointer after the push
N	currentTask->stack = readPSP(iTempRegister);
N
N	//This is necessary to see if a Task has run yet, see PendSVISR
N	currentTask->bInitialized = 1;
N
N	//This is our true scheduler function
N	//select a new task to run
N	taskToExecute = getNextTask();
N
N	//Only if the new task isn't equal to the current one,
N	//call the context switch
N	if(taskToExecute != currentTask)
N	{
N		//States to help the scheduler decide
N		currentTask->state	 = READY;
N		taskToExecute->state = RUNNING;
N
N		//Update current task
N		currentTask = taskToExecute;
N
N		//call pendsv interrupt to perform the context switch
N		NVIC_INT_CTRL_R |= (1<<28);
X		(*((volatile unsigned long *)0xE000ED04)) |= (1<<28);
N	}else{
N		currentTask->state	 = RUNNING;
N		//Clearly no need to switch anything so we
N		//just restore things like they were before the Systick
N		popRegistersFromCurrentPSP(iTempRegister);
N	}
N}
N
N/*
N * This ISR always has the lowest priority and thus will run last
N * of all interrupts. It is recommended by ARM to use this interrupt
N * for the context switch. And thus we have :)
N */
Nvoid PendSVISR(void)
N{
N	//Update the CPU PSP to newly selected task, stack
N	writePSP(taskToExecute->stack);
N
N	//This modifies the Main stack to return
N	//to thread mode after the ISR, and thus
N	//run our functions
N	int * msp = readMSP(iTempRegister);
N	*((uint32_t*)++msp) = THREAD_RETURN;
X	*((uint32_t*)++msp) = 0xFFFFFFFD;
N
N
N	//Is the task initialized? If it hasn't (run), the software
N	//context (r4-r11) hasn't been saved yet, and thus shouldn't
N	//be popped back to the CPU
N	if(taskToExecute->bInitialized)
N	{
N		//Otherwise we can safely pop things :)
N		popRegistersFromCurrentPSP(iTempRegister);
N	}
N}
N
N/*
N * Our genuine scheduler. Currently very static and
N * not-advanced
N *
N * returns a pointer to the selected task
N */
Ntask * getNextTask()
N{
N	static int i=0;
